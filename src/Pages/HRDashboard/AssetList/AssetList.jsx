...
const AssetList = () => {
  ...
  const [assets, refetch] = useAsset({ search, sort, product_type: productType });
...
<div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
  <div className="max-w-7xl mx-auto">
    ...
    <div className="mb-8">
      ...
      <p className="mt-2 text-sm text-gray-600">Manage and track your company assets</p>
    </div>
            ...
            {assets.map((asset) => (
              <tr key={asset._id} className="hover:bg-gray-50 transition-colors">
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm font-medium text-gray-900">{asset.product_name}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap">
                ...
                <td className="px-6 py-4 whitespace-nowrap text-center">
                  <div className="text-sm text-gray-900 font-medium">{asset.product_quantity}</div>
                </td>
                <td className="px-6 py-4 whitespace-nowrap text-center">
